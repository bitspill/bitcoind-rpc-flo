  ...
  var req = this.protocol.request(options, function(res) {
    ...
    res.on('end', function() {
      ...
      if (res.statusCode === 500 && buf.toString('utf8') === 'Work queue depth exceeded') {
        var exceededError = new Error('Flo JSON-RPC: ' + buf.toString('utf8'));
...
RpcClient.callspec = {
  ...
  sendFrom: 'str str float int str str str',
  sendMany: 'str obj int str str',  //not sure this is will work
